	...
	<div class="container">
	  <div class="row">
		<div class="col-lg-8 ftco-animate">  <!-- 사이드바 위치조정에꼭필요 -->
			...
			<label onclick="location.href='customerLoginForm.do'" class="mr-3" style="margin: 10px">로그인 하러가기</label>
			<label onclick="location.href='main.do'" class="mr-3" style="margin: 10px">홈으로 돌아가기</label>
			</div>
		</div> <!-- .col-md-8 -->
