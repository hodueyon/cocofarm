      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>FARMER PAGE</span></p>
            <h1 class="mb-0 bread">FARMER PAGE</h1>
          </div>
        </div>
      </div>
    </div>
		...
		<div class="siteSingle">
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <p>매일 농부의 손으로 거둔 자연의 선물을 <br> 집으로 배송해드립니다.  <br>제철이 주는 제 맛을 기쁜 마음으로 먹을 수 있도록, 계절을 느끼며 장을 보고 매일 요리를 하는 맛있는 일상을 꿈꾸어보세요.</p>
            </div>
          </div>
